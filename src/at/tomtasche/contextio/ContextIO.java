 ...
 */
public class ContextIO extends ContextIOBase {
     ...
     *
     * @param account accountId or email address of the mailbox you want to
     * query
     ...
     * @param account accountId or email address of the mailbox you want to
     * query
     * @param params Query parameters for the API call: 'email', 'to', 'from',
     * 'cc', 'bcc', 'limit'
     * @return ContextIOResponse
     */
     ...
     *
     * @param params Query parameters for the API call: 'email', 'server',
     ...
     *
     * @param params either a string or assoc array with email as its key
     * @return ContextIOResponse
     */
     ...
     *
     * @param params Query parameters for the API call: 'credentials',
     * 'mailboxes'
     * @return ContextIOResponse
     */
     ...
     * @param account accountId or email address of the mailbox you want to
     * query
     * @param params Query parameters for the API call: 'emailMessageId',
     * 'from', 'dateSent',
     * @return ContextIOResponse
     */
